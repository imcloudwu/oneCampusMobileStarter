...
public class OAuthHelper {
    ...
    public init(clientId cid: String, clientSecret cs: String, redirectUrl ru: String = "http://_blank", scope s: String = "User.Mail,User.BasicInfo,1Campus.Notification.Read,1Campus.Notification.Send,*:sakura") {
        self.client_id = cid
